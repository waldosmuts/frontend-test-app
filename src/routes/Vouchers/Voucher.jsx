...
export default function Voucher({ data }) {
    ...
    return (
        <article className="flex flex-col overflow-hidden rounded-lg bg-white shadow-md hover:shadow-xl transition duration-300 hover:scale-110 relative">
            ...
            <div className="flex flex-col grow">
                ...
                <div className="mt-3 mx-6 font-medium text-neutral-500 text-sm relative flex flex-col justify-between h-full">
                    ...
                    <div className="flex items-end justify-between w-full my-6">
