export default function Header() {
    return (
        <header className="font-montserrat font-light relative overflow-hidden">
            <div className="h-[600px] bg-fixed bg-cover bg-no-repeat bg-bottom brightness-75" style={{ backgroundImage: "url(https://www.tintswalo.com/atlantic/wp-content/uploads/2022/01/Tintswalo-Atlantic-Luxury-Boutique-Hotel-Pool-Deck-Gallery-8.jpg)" }} />
