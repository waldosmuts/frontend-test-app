...
export default function Footer() {
    return (
        <footer className="flex flex-col items-center py-12 px-24 bg-gradient-to-r text-white from-teal-400 to-tintswalo-primary font-montserrat font-light">
            ...
            <div className="flex gap-x-3 text-lg mt-12">
            ...
            <div className="flex w-full justify-center gap-x-3 text-sm font-normal mt-3">
